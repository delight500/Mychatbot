...
?>
<?php 
		$sql = "DELETE FROM message WHERE NOT `id`= 1";
   ...
   <body onload="script();">
               ...
               <div class="card">
                  ...
                  <div class="card-header">
                    <div class="input-group">
					   <input id="input-me" type="text" name="messages" class="form-control input-sm" placeholder="Type your message here..."  minlength="1"/>
      ...
      <script type="text/javascript">
		 ...
		 function send_msg(){
			...
			jQuery('.messages-list').append(html).fadeIn();;
			jQuery('#input-me').val('');
			if(txt){
				jQuery.ajax({
